...
const RegistrationSidebar = ({ isActive, onStepChange }) => {
  return (
    <div className="w-full md:w-80 p-4 bg-gray-50 md:mr-8 mt-8 md:mt-0">
      <div className="sticky top-20">
          ...
          >
            <div
              className={`w-8 h-8 rounded-full ${
                isActive === 'Registration' || isActive === 'FamilyDetails'
        ...
        <div className="mb-4">
          ...
          >
            <div
              className={`w-8 h-8 rounded-full ${
                isActive === 'FamilyDetails' ? 'bg-green-600 text-white' : 'bg-gray-300 text-gray-600'
              } flex items-center justify-center`}
            >
              2
            </div>
