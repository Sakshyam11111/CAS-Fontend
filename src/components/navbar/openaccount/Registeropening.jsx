                ...
                <div key={index} className="border p-4 rounded-lg flex items-start flex-col sm:flex-row hover:shadow-lg transition-shadow duration-200">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex flex-col sm:flex-row justify-between mt-4">
                            <Link to="/formregister" className="bg-green-600 text-white px-8 py-2 rounded-3xl flex items-center hover:bg-green-700 transition duration-200">
                                <FaCheck className="mr-2" /> Apply
                            </Link>
                            <Link to="/learnmore" className="bg-green-600 text-white px-4 py-2 rounded-3xl flex items-center hover:bg-green-700 transition duration-200">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-4">
                        ...
                        <div className="flex flex-col sm:flex-row items-center mt-2">
                            <input type="radio" id="in-nepal" name="residency" className="mr-2 h-5 w-5" onChange={handleInNepalChange} />
                            <label htmlFor="in-nepal" className="mr-4">In Nepal</label>
                            <input type="radio" id="outside-nepal" name="residency" className="mr-2 h-5 w-5" onChange={handleOutsideNepalChange} />
                        ...
                        <div className="mt-4 p-4 border rounded-lg">
                            ...
                            <div className="flex flex-col sm:flex-row items-center mt-2">
                                <div className="flex items-center mr-4">
                                    <input type="radio" id="has-nrn" name="nrc-status" className="mr-2 h-6 w-6" onChange={handleNRNCardChange} />
                                    <label htmlFor="has-nrn">I have NRN Card</label>
                                </div>
                                <div className="flex items-center">
                                    <input type="radio" id="no-nrn" name="nrc-status" className="mr-2 h-6 w-6" onChange={handleNoNRNCardChange} />
                    ...
                    {hasNRNCard && renderAccounts(nrcAccounts)}
                    {noNRNCard && renderAccounts(noNRCAccounts)}
                    {isInNepal && renderAccounts(accounts)}
                </div>
